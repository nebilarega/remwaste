...
export const Card = ({ card, onClick, isSelected = false }: CardProps) => {
  ...
  return (
    <div
      className={`min-h-[450px] rounded-lg shadow-md dark:shadow-gray-900 dark:border-1 dark:border-gray-500 overflow-hidden hover:shadow-lg transition-all duration-300 cursor-pointer flex flex-col ${
    ...
    >
      <div
        className={`relative flex-1 ${
          isFullscreen
            ? "fullscreen-backdrop fixed inset-0 bg-black bg-opacity-50 z-[99999]"
            : "justify-center"
        }`}
      >
        <img
