...
const PrimaryButton: React.FC<PrimaryButtonProps> = ({
  ...
  return (
    <button
      ...
      }  text-white hover:text-black dark:text-black dark:hover:text-white justify-center rounded-md px-3 py-2.5 text-sm font-semibold leading-6 shadow-sm transition-all  ${className}`}
    >
      {children}
    </button>
  );
